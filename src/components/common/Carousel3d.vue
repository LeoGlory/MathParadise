<template>
    ...
    <div class="carousel-3d-container" :style="{height: 23.25 + 'rem'}">
        <div class="carousel-3d-slider" :style="{width: 16.25 + 'rem', height: 23.25 + 'rem'}">
            <slot></slot>
        </div>
        <controls v-if="controlsVisible" :next-html="controlsNextHtml" :prev-html="controlsPrevHtml" :width="16.25" :height="23.25"></controls>
        <audio src="" id="sliderSnd"></audio>
    </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    this.audio = document.getElementById('sliderSnd')
    this.audio.src = this.sndPath
  },
